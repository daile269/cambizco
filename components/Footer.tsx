      ...
      <div className="container-custom py-8 ml-8 mr-8">
        <div className="grid grid-cols-1 md:grid-cols-3">
          ...
          <div className="space-y-4 mb-6">
            ...
            <p className="text-gray-300 leading-relaxed">
              Đơn vị Fulfillment số 1 Việt - Cam chuyên nghiệp, linh hoạt, khoa
              học, nhanh chóng.
            </p>
            <div className="space-y-2">
              <p className="text-gray-300">
                <span className="font-semibold">Địa chỉ:</span> No.20H St.45BT
          ...
          <div className="space-y-4 mb-6 md:ml-6 md:mr-6">
            ...
            <nav className="space-y-3">
              <Link
                href="/#services"
                className="block py-2 text-gray-300 hover:text-blue-400 border-b border-gray-600 hover:border-blue-400 transition-all"
              >
                Dịch vụ
              </Link>
              <Link
        ...
        <div className="mt-12 pt-8 border-t border-gray-700">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-gray-400 text-sm">CamBiz Fulfillment</p>
